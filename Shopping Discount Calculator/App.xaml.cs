...
//using Shopping_Discount_Calculator.ViewModels;
...
namespace Shopping_Discount_Calculator
{
    public partial class App : Application
    {
        ...
        {
            RootFrame.Navigate(new Uri("/About.xaml", UriKind.Relative));
        }

        private void appBarMenuHowTo_Click(object sender, EventArgs e)
        {
            RootFrame.Navigate(new Uri("/HowToUse.xaml", UriKind.Relative));
        }

        private void appBarMenuTaxes_Click(object sender, EventArgs e)
        {
        ...
        {
            RootFrame.Navigate(new Uri("/StartScreen.xaml", UriKind.Relative));
        }
